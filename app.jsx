      ...
      <div className="tl-topbar" style={{borderBottom:"1px solid #e0e0e0",background:"#fff",flexShrink:0,padding:"6px 12px",display:"flex",alignItems:"center",gap:6,flexWrap:"wrap"}}>
        ...
        <div className="tl-days" style={{display:"flex",gap:2,alignItems:"center"}}>
          ...
          <div style={{position:"relative",flexShrink:0,marginLeft:2}}>
            <button onClick={()=>setShowCal(!showCal)} style={{width:28,height:28,border:"1px solid #d0d0d0",borderRadius:6,background:showCal?"#f0f0ff":"#fff",cursor:"pointer",display:"flex",alignItems:"center",justifyContent:"center",padding:0,color:"#888"}}><I name="calendar" size={14}/></button>
