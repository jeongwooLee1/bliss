            ...
            <div style={{fontSize:13}}>
              ...
              <div style={{padding:"8px 14px 10px",background:"#fafbfc"}}>
                ...
                <div style={{display:"flex",gap:6,flexWrap:"wrap"}}>
                  <input className="inp admin-place-inp" value={b.naverEmail||""} onChange={e=>updateField(b.id,"naverEmail",e.target.value)}
                    placeholder="Gmail" style={{flex:"1 1 120px",background:"#fff",border:"1px solid #e8e8e8",fontSize:12,padding:"8px 10px",borderRadius:8}}/>
                  <input className="inp admin-place-inp" value={b.naverBizId||""} onChange={e=>updateField(b.id,"naverBizId",e.target.value)}
                    placeholder="Biz ID" style={{width:80,background:"#fff",border:"1px solid #e8e8e8",fontSize:12,padding:"8px 10px",borderRadius:8}}/>
                  {b.naverEmail && <input type="number" className="inp admin-place-inp" value={b.naverColCount||1} min={1} max={5}
                    onChange={e=>updateField(b.id,"naverColCount",Math.max(1,Math.min(5,parseInt(e.target.value)||1)))}
                    style={{width:44,background:"#fff",border:"1px solid #e8e8e8",fontSize:12,padding:"8px 4px",borderRadius:8,textAlign:"center"}}/>}
                </div>
              </div>
            </div>
            {/* Footer */}
