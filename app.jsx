  ...
  return (
    <div className="ov" onClick={onClose} style={{alignItems:"flex-start",paddingTop:16,paddingBottom:20,overflow:"auto",WebkitOverflowScrolling:"touch",justifyContent:"center"}}>
      <div ref={modalRef} className="modal-res" onClick={e=>e.stopPropagation()} style={{background:"#fff",
        ...
        {/* ═══ Chrome-style Tabs ═══ */}
        <div style={{display:"flex",alignItems:"flex-end",gap:0,padding:"0",background:"#f5f5f5",borderRadius:"12px 12px 0 0",position:"sticky",top:0,zIndex:10,borderBottom:"1px solid #e0e0e0"}}>
          {/* 예약 탭 */}
...
const CSS = `
  ...
  *{box-sizing:border-box;margin:0;padding:0}
  ...
  @media(max-width:768px){
    ...
    .timeline-scroll{scroll-snap-type:x proximity;-webkit-scroll-snap-type:x proximity}
