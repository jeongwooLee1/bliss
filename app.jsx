          ...
          {isSchedule && <>
            ...
            <div style={{marginTop:8}}>
              ...
              {f.repeat !== "none" && <div style={{display:"flex",gap:6,alignItems:"center",marginTop:6}}>
                ...
                <input type="date" className="inp" style={{flex:"1 1 130px",minWidth:120,fontSize:12}} value={f.repeatUntil} onChange={e=>set("repeatUntil",e.target.value)}
                  min={f.date}/>
