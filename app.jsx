...
function Timeline({ data, setData, userBranches, viewBranches=[], isMaster, currentUser, setPage, bizId }) {
  ...
  return (
    <div style={{display:"flex",flexDirection:"column",flex:1,minHeight:0}}>
      ...
      {/* Timeline Grid */}
      <div ref={scrollRef} className="timeline-scroll" onScroll={e=>{const hdr=document.querySelector(".mob-hdr");if(!hdr)return;if(e.target.scrollTop>20){hdr.style.transform="translateY(-100%)";hdr.style.opacity="0";}else{hdr.style.transform="translateY(0)";hdr.style.opacity="1";}}} style={{flex:1,overflow:"scroll",position:"relative",minHeight:0,WebkitOverflowScrolling:"touch"}}>
...
const S = {
  ...
  mobHdr: { padding:"10px 16px", background:"#fff", borderBottom:"1px solid #e0e0e0", display:"flex", alignItems:"center", gap:12, transition:"transform .3s ease, opacity .3s ease" },
