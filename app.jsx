...
function DetailedSaleForm({ reservation, branchId, onSubmit, onClose, data, setData }) {
  ...
  // Auto-fill default field when total changes
        ...
        <div style={{padding:"14px 16px",borderTop:"2px solid #e0e0e0",background:"#fafafa"}}>
          ...
          {grandTotal > 0 && <div className="sale-pay-row" style={{display:"flex",gap:16,flexWrap:"wrap"}}>
            {svcTotal > 0 && <div style={{flex:1,minWidth:0,padding:"8px 12px",background:"#fff",borderRadius:8,border:"1px solid #e0e0e0"}}>
              ...
              <div style={{display:"flex",gap:6,alignItems:"center",flexWrap:"wrap"}}>
                {[
                  {k:"svcCard",label:"카드",clr:"#1565c0",bdr:"#90caf9"},
                  {k:"svcCash",label:"현금",clr:"#e65100",bdr:"#ffcc80"},
                  {k:"svcTransfer",label:"입금",clr:"#2e7d32",bdr:"#a5d6a7"},
                ].map(({k,label,clr,bdr})=><div key={k} style={{display:"flex",alignItems:"center",gap:3}}>
            ...
            {prodTotal > 0 && <div style={{flex:1,minWidth:0,padding:"8px 12px",background:"#fff",borderRadius:8,border:"1px solid #e0e0e0"}}>
              ...
              <div style={{display:"flex",gap:6,alignItems:"center",flexWrap:"wrap"}}>
                {[
                  {k:"prodCard",label:"카드",clr:"#1565c0",bdr:"#90caf9"},
                  {k:"prodCash",label:"현금",clr:"#e65100",bdr:"#ffcc80"},
                  {k:"prodTransfer",label:"입금",clr:"#2e7d32",bdr:"#a5d6a7"},
                ].map(({k,label,clr,bdr})=><div key={k} style={{display:"flex",alignItems:"center",gap:3}}>
                  <span style={{fontSize:10,color:clr,fontWeight:600}}>{label}</span>
                  <input className="inp" type="number" value={payMethod[k]||""} placeholder="0"
          ...
          {grandTotal > 0 && <div style={{fontSize:9,color:"#bbb",marginTop:6}}>필드 클릭 → 전액 자동입력 / 다른 필드 입력 시 자동 분배</div>}
        </div>
